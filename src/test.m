...
%% getFiducialPoints
image = imread('../data/George_W_Bush/George_W_Bush_0009.jpg');
...
%templateCoordinates = [35.6, -0.58, 1229; 39.07, -29.11, 1236; 41.89, -64.56, 1248;...
%    39.97, -94.83, 1266; 85.95, -35.42, 1226; 89.10, -52.49, 1225;...
%    88.05, -63.8, 1234; 105.2, -20.28, 1230; 109.1, -70.86, 1250];
...
rotatedPoints = R*D*normalPoints_normed';
ptCloud3 = pointCloud(rotatedPoints');
%pcshow(ptCloud3);
%hold on;

translatedPoints = rotatedPoints + [repmat(t,1,size(normalPoints,1)); zeros(size(normalPoints,1),1)'];
